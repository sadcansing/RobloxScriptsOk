...
local Config = {
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/sadcansing/RobloxScriptsOk/refs/heads/main/LaRivals.lua", -- The raw URL of your main script
    ...
    ShowYoutube     = true,
    YoutubeURL      = "https://www.youtube.com/channel/UCXrDRd-cnXzlZdE1aCbT3hQ?sub_confirmation=1",
    ...
    HubDescription  = "Subscribe" -- The text shown below the title
}
